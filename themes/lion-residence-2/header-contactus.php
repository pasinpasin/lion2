...
<div id="page" class="site">
 ...
 <div class="container-fluid" style="position: relative;">
            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/LionI.png" style="display: block;overflow: visible;width: 130px;height: 40px;"></a><button data-bs-toggle="offcanvas" data-bs-target="#offcanvas-1" class="navbar-toggler"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse flex-grow-0 order-md-first" id="navcol-1">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item"><a class="nav-link active" href="#" style="font-family: URWClassico;color: #fff;">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" style="font-family: URWClassico;color: #fff;">The Project</a></li>
                        <li class="nav-item" style="color: #fff;"><a class="nav-link" href="#" style="font-family: URWClassico;color: var(--bs-body-bg);">About Us</a></li>
                    </ul>
        ...
        <div class="row">
            <div class="col d-flex d-sm-flex d-lg-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-lg-center align-items-lg-center justify-content-xl-center d-flex justify-content-center align-items-center ratio ratio-3x4" id="colcontactus"><img class="img-fluid" id="imgcontact" src="<?php echo get_template_directory_uri(); ?>/assets/img/Rectangle711.png">
                <div class="d-flex justify-content-center align-items-center" style="position: absolute;">
                    <h1 style="color: var(--bs-body-bg);border-style: none;">Contact Us</h1>
                </div>
            </div>
        </div>
    </div>
