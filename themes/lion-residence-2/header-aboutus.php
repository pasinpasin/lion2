...
<body style="font-family: URWClassico;--bs-body-color: #13353F;--bs-body-font-weight: normal;background: #f0f0f0;">
<head>
...
<div id="page" class="site">
	...
	<header id="masthead3">
        ...
        <div class="container-fluid py-4 py-xl-5 mb-5" style="position: relative;">
            ...
            <nav class="navbar navbar-expand-md navbar-light2" style="z-index: 10;width: 100%;background: transparent;position: absolute;color: #13353f;">
                <div class="container"><a class="navbar-brand d-flex align-items-center" href="#" style="color: #13353f;"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/logoaboutus.png" style="display: block;overflow: visible;width: 130px;height: 40px;"></a><button data-bs-toggle="offcanvas" data-bs-target="#offcanvas-1" class="navbar-toggler"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse flex-grow-0 order-md-first" id="navcol-1">
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item"><a class="nav-link active" href="#" style="font-family: URWClassico;color: #13353f;">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" style="font-family: URWClassico;color: #13353f;">The Project</a></li>
                            <li class="nav-item" style="color: #fff;"><a class="nav-link" href="#" style="font-family: URWClassico;color: #13353f;">About Us</a></li>
                        </ul>
                        <ul class="navbar-nav d-md-none">
                            <li class="nav-item"><a class="nav-link active" href="#" style="color: #13353f;">First Item</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" style="color: #13353f;">Second Item</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" style="color: #13353F;">Third Item</a></li>
                        </ul>
                    </div>
                    <ul class="navbar-nav d-none d-md-inline-flex">
                        <li class="nav-item"><a class="nav-link" href="#" style="font-family: URWClassico;color: #13353F;">Typologies</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" style="font-family: URWClassico;color: #13353f;">Gallery</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" style="font-family: URWClassico;color: #13353F;">Contact Us</a></li>
                    </ul>
                </div>
            </nav>
        </div>
